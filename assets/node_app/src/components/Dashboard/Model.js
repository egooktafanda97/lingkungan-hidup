...
const getLineCountRetribusi = async (response) => {
  const gets = await axios
    .get(localStorage.getItem("base_url") + "api/dashboard/getLineChartCount", {
      headers: {
...
const getBarCountRetribusi = async (response) => {
  const gets = await axios
    .get(localStorage.getItem("base_url") + "api/dashboard/getLaporanTahunan", {
      headers: {
        Authorization: "bearer " + localStorage.getItem("token"),
      },
    })
