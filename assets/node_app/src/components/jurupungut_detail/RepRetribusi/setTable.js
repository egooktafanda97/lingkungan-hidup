...
export const Build = (data, response, footer, action) => {
  ...
  data.forEach((results) => {
    var dataSub = {
      ...
      nama_pemilik: results.nama_pemilik,
      alamat: results.alamat,
      nama_usaha: results.nama_usaha,
      tipe_usaha: results.tipe_usaha.tipe_usaha,
      jumlah_retribusi: rupiah("" + results.tipe_usaha.jumlah_retribusi, "Rp "),
      JAN: "",
      FEB: "",
      MAR: "",
      APR: "",
    ...
    dataSub.TOTAL = rupiah("" + dataSub.TOTAL, "Rp ");
    result.push(dataSub);
  });
  response(result);
  const Foot = () => {
