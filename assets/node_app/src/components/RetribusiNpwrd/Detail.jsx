                ...
                <div className='w-100 cards1 p-3'>
                  ...
                  <div>
                    <div className='list-detail'>
                      ...
                      <strong>
                        {data.no_urut != undefined && data.no_urut}
                      </strong>
                    </div>
                    <hr />
                    <div className='list-detail'>
                      <strong>NPWRD</strong>
                      <strong>{data.npwrd != undefined && data.npwrd}</strong>
                    </div>
                    <hr />
                    <div className='list-detail'>
                      <strong>Nama</strong>
                    ...
                    <div className='list-detail'>
                      ...
                      <strong>
                        {data.menyetoran_berdasarkan != undefined &&
                          data.menyetoran_berdasarkan}
                      </strong>
                    </div>
                    <hr />
                    <div className='list-detail'>
