	...
	$("head").append(
		$("<link/>", {
			...
			href:
				...
				"/assets/template/dist/css/skins/" +
				color +
				".css",
			id: "skin-css",
		})
...
$(".demo-toggle-skin").each(function (i) {
	...
	me.on("click", function (e) {
		...
		localStorage.setItem(
			"skin",
			_this.attributes.title.nodeValue.toLowerCase()
		);
